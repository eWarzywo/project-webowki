    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-zinc-900 text-zinc-100 rounded-xl p-6 w-full max-w-md sm:w-1/2 md:w-1/3 lg:w-1/4 relative">
                ...
                <p className="mb-6">
                    Are you sure you want to mark <b>{choreName}</b> as not done?
                </p>
...
function DetailsBox({ name, description, dueDate, priority, doneBy, onClose }: DetailsBoxProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-zinc-900 text-zinc-100 rounded-xl p-6 w-full max-w-lg sm:w-2/3 md:w-1/2 lg:w-1/3 relative">
        ...
        >
            ...
            <div className="flex flex-col w-full sm:w-1/5 justify-center mt-2 sm:mt-0">
                <input
                    ...
                    className="bg-red-600 text-white px-4 py-2 rounded-xl gap-2.5 hover:bg-red-700 cursor-pointer text-sm font-medium w-full"
                />
            </div>
        </div>
    );
