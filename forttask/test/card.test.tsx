...
describe('Card Component', () => {
    ...
    it('uses the correct endpoint based on dataType', async () => {
        ...
        render(<Card title="Events" subtitle="Test" dataType={DataType.events} selectedDate={today} refresh={false} />);
        ...
        render(<Card title="Chores" subtitle="Test" dataType={DataType.chores} selectedDate={today} refresh={false} />);
    ...
    it('refreshes data when refresh prop changes', async () => {
        ...
        const { rerender } = render(
            <Card title="Test" subtitle="Test" dataType={DataType.events} selectedDate={today} refresh={false} />,
        );
        ...
        rerender(<Card title="Test" subtitle="Test" dataType={DataType.events} selectedDate={today} refresh={true} />);
